			...
			<div class="main-product-tab-area">
				<div class="tab-menu mb-25">
					<div class="section-ttitle">
						<h1 style="font-weight: bold;">Sản phẩm mới</h1>
					</div>
					<!-- Nav tabs -->
							...
							<c:forEach var = "i" begin = "0" step="2" end = "${lstSanPhamMoi.size() - 1}">
								...
								<div class="single-product">
									...
									<div class="pro-content">
										...
										<div class="pro-actions">
											<div class="actions-primary">
												<a class="addGioHang" data-sp="${lstSanPhamMoi.get(i).maSanPham }" href="javascript:void(0)" title="Thêm vào giỏ hàng"> + Thêm vào giỏ hàng</a>
											</div>
								...
								<div class="single-product">
									...
									<div class="pro-content">
										...
										<div class="pro-actions">
											<div class="actions-primary">
												<a class="addGioHang" data-sp="${lstSanPhamMoi.get(i+1).maSanPham }" href="javascript:void(0)" title="Thêm vào giỏ hàng"> + Thêm vào giỏ hàng</a>
											</div>
										</div>
									</div>
									<!-- Product Content End -->
	...
	<div class="second-arrivals-product pb-45 pb-sm-5">
		<div class="container">
			<div class="main-product-tab-area">
				<div class="tab-menu mb-25">
					<div class="section-ttitle">
						<h1 style="font-weight: bold;">Sản phẩm bán chạy</h1>
					</div>
					<!-- Nav tabs -->
					<ul class="nav tabs-area" role="tablist">
						<li class="nav-item"><a class="nav-link active"
								...
								<c:forEach var="sp" items="${lstSanPhamBanChay }">
									...
									<div class="single-product">
										...
										<div class="pro-content">
											...
											<div class="pro-actions">
												<div class="actions-primary">
													<a class="addGioHang" data-sp="${sp.maSanPham }" href="javascript:void(0)" title="Thêm vào giỏ hàng"> + Thêm
														vào giỏ hàng</a>
												</div>
											</div>
										</div>
	...
	<div class="like-product ptb-95 off-white-bg pt-sm-50 pb-sm-55 ">
		<div class="container">
			<div class="like-product-area">
				<h1 style="font-weight: bold; font-size: 30px" class="section-ttitle2 mb-30">Sản phẩm nổi bật</h1>
				<!-- Arrivals Product Activation Start Here -->
