		...
		<div class="container">
			<div class="breadcrumb">
				<ul class="d-flex align-items-center">
					...
					<li class="active"><a href="product.html">Chi tiết</a></li>
				</ul>
			</div>
		</div>
		<!-- Container End -->
				...
				<div class="row">
					...
					<div class="col-lg-5 mb-all-40">
						...
						<div class="tab-content">
							<div id="thumb1" class="tab-pane fade show active">
									<a data-fancybox="images" href="../images/${lstAnh.get(0).anh }"><img
										src="../images/${lstAnh.get(0).anh }" alt="product-view"></a>
							</div>
							<c:forEach var="i" begin="1" step="1"
								end="${lstAnh.size() - 1}">
								<div id="thumb<c:out value = "${i+1}"/>" class="tab-pane fade">
									<a data-fancybox="images" href="../images/${lstAnh.get(i).anh }"><img
										src="../images/${lstAnh.get(i).anh }" alt="product-view"></a>
								</div>
							</c:forEach>
						</div>
						...
						<div class="product-thumbnail mt-15">
							<div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
								<c:forEach var="i" begin="0" step="1" end="${lstAnh.size() - 1}">
									<a class="" data-toggle="tab" href="#thumb<c:out value = "${i+1}"/>"><img
										src="../images/${lstAnh.get(i).anh }" alt="product-thumbnail"></a>
								</c:forEach>
							</div>
						</div>
						<!-- Thumbnail image end -->
					...
					<div class="col-lg-7">
						<div class="thubnail-desc fix">
							<h3 class="product-header">${objSanPham.tenSanPham}</h3>
							...
							<div class="pro-price mtb-30">
								<p class="d-flex align-items-center">
									<span class="price"><fmt:formatNumber maxFractionDigits = "3" type="number"
												value="${objSanPham.giaTien }"/> VND</span>
							</div>
							
							<div class="product-size mb-20 clearfix">
								<label>Kích thước</label> 
								<p>${objSanPham.kichThuoc }</p>
							</div>
							<div class="color clearfix mb-20">
								<label>Màu sắc</label>
								<p>${objSanPham.mauSac }</p>
								<ul class="color-list">
							...
							<div class="box-quantity d-flex hot-product2">
								...
								<div class="pro-actions">
									<div class="actions-primary">
										<a class="addGioHang" data-sp="${objSanPham.maSanPham }" href="javascript:void(0)">
											+ Thêm vào giỏ</a>
									</div>
								</div>
							</div>
		...
		<div class="container">
			...
			<div class="hot-deal-active owl-carousel">
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/17.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/18.jpg"/>"
							alt="single-product">
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/19.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/20.jpg"/>"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/21.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/22.jpg"/>"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/22.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/23.jpg"/>"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/8.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/9.jpg"/>"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/15.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/16.jpg"/>"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/13.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/14.jpg"/>"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="<c:url value ="/images/products/1.jpg"/>" alt="single-product"> <img
							class="secondary-img" src="<c:url value ="/images/products/7.jpg"/>"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
