				...
				<div class="navbar-vertical-footer-offset">
					...
					<div class="navbar-vertical-content">
						<ul class="navbar-nav navbar-nav-lg nav-tabs">
							<!-- Dashboards -->
							<li class="nav-item "><a
								class="js-nav-tooltip-link nav-link " href="welcome-page.html"
							...
							<li class="navbar-vertical-aside-has-menu show"><a
								...
								<ul class="js-navbar-vertical-aside-submenu nav nav-sub">
									<li class="navbar-vertical-aside-has-menu "><a
										...
										<ul class="js-navbar-vertical-aside-submenu nav nav-sub">
											<li class="nav-item"><a class="nav-link "
												href="users.html" title="Overview"> <span
									...
									<li class="navbar-vertical-aside-has-menu "><a
										...
										<ul class="js-navbar-vertical-aside-submenu nav nav-sub">
											<li class="nav-item"><a class="nav-link "
												href="project.html" title="Overview"> <span
													class="tio-circle-outlined nav-indicator-icon"></span> <span
													class="text-truncate">Danh sách</span>
											</a></li>
											<li class="nav-item"><a class="nav-link "
												href="project-files.html" title="Files"> <span
													class="tio-circle-outlined nav-indicator-icon"></span> <span
			...
			<div class="navbar-vertical-container">
				...
				<div class="navbar-vertical-content">
					<ul class="navbar-nav nav-compact">
						<!-- Dashboards -->
						<li class="nav-item"><a class="nav-link "
							href="welcome-page.html" title="Welcome Page"> <i
								class="tio-home-vs-1-outlined nav-icon"></i> <span
						...
						<li class="navbar-vertical-aside-has-menu nav-item"><a
							...
							<ul class="js-navbar-vertical-aside-submenu nav nav-sub">
								...
								<li class="navbar-vertical-aside-has-menu "><a
									...
									<ul class="js-navbar-vertical-aside-submenu nav nav-sub">
										<li class="nav-item"><a class="nav-link "
											href="account-settings.html" title="Settings"> <span
												class="tio-circle-outlined nav-indicator-icon"></span> <span
												class="text-truncate">Danh sách</span>
										</a></li>
										<li class="nav-item"><a class="nav-link "
								...
								<li class="navbar-vertical-aside-has-menu "><a
									...
									<ul class="js-navbar-vertical-aside-submenu nav nav-sub">
										...
										<li class="nav-item"><a class="nav-link "
											href="ecommerce-manage-reviews.html" title="Manage Reviews">
