						...
						<nav>
							<ul class="vertical-menu-list">
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/4.png" alt="menu-icon"></span>Điện
										thoại - Máy tính bảng<i class="fa fa-angle-right"
									...
									<ul class="ht-dropdown megamenu first-megamenu">
										...
										<!-- Single Column End -->
										<!-- Single Megamenu images Start -->
										<li class="megamenu-img"><a href="shop.html"><img
												src="images/vertical-menu/sub-img1.jpg" alt="menu-images"></a>
											<a href="shop.html"><img
												src="images/vertical-menu/sub-img2.jpg" alt="menu-images"></a>
											<a href="shop.html"><img
												src="images/vertical-menu/sub-img3.jpg" alt="menu-images"></a>
										</li>
										<!-- Single Megamenu images End -->
									</ul> <!-- Vertical Mega-Menu End --></li>

								<li><a href="shop.html"><span><img
											src="images/vertical-menu/9.png" alt="menu-icon"></span>Laptop
										- máy tính <i class="fa fa-angle-right" aria-hidden="true"></i></a>
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/8.png" alt="menu-icon"></span>Điện
										tử - điện lạnh<i class="fa fa-angle-right" aria-hidden="true"></i></a>
									<!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/11.png" alt="menu-icon"></span>Máy
										ảnh - quay phim<i class="fa fa-angle-right" aria-hidden="true"></i></a>
									<!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/1.png" alt="menu-icon"></span>Ô tô -
										xe máy<i class="fa fa-angle-right" aria-hidden="true"></i></a> <!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
											<ul>
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/3.png" alt="menu-icon"></span>Dụng
										cụ thể thao<i class="fa fa-angle-right" aria-hidden="true"></i></a>
									<!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/10.png" alt="menu-icon"></span>Thời
										trang - phụ kiện<i class="fa fa-angle-right"
										aria-hidden="true"></i></a> <!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/7.png" alt="menu-icon"></span>Nhà
										cửa - đời sông<i class="fa fa-angle-right" aria-hidden="true"></i></a>
									<!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/5.png" alt="menu-icon"></span>Sức
										khoẻ - làm đẹp<i class="fa fa-angle-right" aria-hidden="true"></i></a>
									<!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/icon-expand.png" alt="menu-icon"></span>Hàng
										quốc tế<i class="fa fa-angle-right" aria-hidden="true"></i></a> <!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
											<ul>
								...
								<li><a href="shop.html"><span><img
											src="images/vertical-menu/10.png" alt="menu-icon"></span>Voucher
										- dịch vụ - thẻ cào<i class="fa fa-angle-right"
										aria-hidden="true"></i></a> <!-- Vertical Mega-Menu Start -->
									<ul class="ht-dropdown megamenu first-megamenu">
										<!-- Single Column Start -->
										<li class="single-megamenu">
					...
					<div class="col-lg-5 mb-all-40">
						...
						<div class="tab-content">
							<div id="thumb1" class="tab-pane fade show active">
								<a data-fancybox="images" href="images/products/35.jpg"><img
									src="images/products/35.jpg" alt="product-view"></a>
							</div>
							<div id="thumb2" class="tab-pane fade">
								<a data-fancybox="images" href="images/products/13.jpg"><img
									src="images/products/13.jpg" alt="product-view"></a>
							</div>
							<div id="thumb3" class="tab-pane fade">
								<a data-fancybox="images" href="images/products/15.jpg"><img
									src="images/products/15.jpg" alt="product-view"></a>
							</div>
							<div id="thumb4" class="tab-pane fade">
								<a data-fancybox="images" href="images/products/4.jpg"><img
									src="images/products/4.jpg" alt="product-view"></a>
							</div>
							<div id="thumb5" class="tab-pane fade">
								<a data-fancybox="images" href="images/products/5.jpg"><img
									src="images/products/5.jpg" alt="product-view"></a>
							</div>
						</div>
						...
						<div class="product-thumbnail mt-15">
							<div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
								<a class="active" data-toggle="tab" href="#thumb1"><img
									src="images/products/35.jpg" alt="product-thumbnail"></a> <a
									data-toggle="tab" href="#thumb2"><img
									src="images/products/13.jpg" alt="product-thumbnail"></a> <a
									data-toggle="tab" href="#thumb3"><img
									src="images/products/15.jpg" alt="product-thumbnail"></a> <a
									data-toggle="tab" href="#thumb4"><img
									src="images/products/4.jpg" alt="product-thumbnail"></a> <a
									data-toggle="tab" href="#thumb5"><img
									src="images/products/5.jpg" alt="product-thumbnail"></a>
							</div>
						</div>
						<!-- Thumbnail image end -->
					</div>
						...
						<div class="thubnail-desc fix">
							...
							<div class="pro-price mtb-30">
								<p class="d-flex align-items-center">
									<span class="prev-price">16.51</span><span class="price">$15.19</span><span
										class="saving-price">save 8%</span>
								</p>
							</div>
							<p class="mb-20 pro-desc-details">Faded short sleeves t-shirt
								with high neckline. Soft and stretchy material for a comfortable
								...
								<div class="pro-actions">
									...
									<div class="actions-secondary">
										<a href="compare.html" title="" data-original-title="Compare"><i
											...
											href="wishlist.html" title="" data-original-title="WishList"><i
					...
					<div class="tab-content thumb-content border-default">
						<div id="dtail" class="tab-pane fade show active">
							<p>Fashion has been creating well-designed collections since
								...
								with youthful elegance and unmistakable signature style. All the
		...
		<div class="container">
			...
			<div class="hot-deal-active owl-carousel">
				...
				<div class="single-product">
					...
					<div class="pro-img">
						<a href="product.html"> <img class="primary-img"
							src="images/products/22.jpg" alt="single-product"> <img
							class="secondary-img" src="images/products/23.jpg"
							alt="single-product">
						</a> <a href="#" class="quick_view" data-toggle="modal"
							data-target="#myModal" title="Quick View"><i
							class="lnr lnr-magnifier"></i></a>
